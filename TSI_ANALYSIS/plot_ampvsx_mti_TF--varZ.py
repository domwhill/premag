...
p1wt = TEL.plot_custom_xlineout_amp_tevol(fig,ax_dyqy,path_list,var_amp='Te',time_list=time_list,
                                    style_list=style_list,mstyle_list=mstyle_list,
                                    leg_dict=dict_list,axleg=cax_dyqy)
...
p2 = TEL.plot_ylineout_custom(fig,ax_yTe,path_list,var_amp='Te',
                                time=time_list[-1],style_list=style_list,
...
if False:
    p2 = TEL.plot_ylineout_custom(fig,ax_yTe,path_list,
                                    var_amp='Te',time=time_list[1],
                                    style_list=style_list,mstyle_list=mstyle_list,
                                    dict_list=dict_list)
...
for ax in ax2_list:
    ax.yaxis.set_major_locator(MaxNLocator(4,prune='both'))#sets the max number of ticks on yaxis
