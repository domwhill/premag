...
def get_growth(k,Z_in,lambda_T_in,tau_ei_in,n_e_in,T_e_in,Bz_in,wt_in,dxn_in,dxT_in,dxBz_in):
    '''
    ...
    B2 = 0.6*(i*K*DT-VB)*i*K*DR + (3.0/20.0)*LambdaG*SG - (3.0/20.0)*SP*i*K + (3.0/20.0)*SE*(K2)
...
for ix in range(ix_min,ix_max):
    ...
    lambda_T_in = lambda_T[iy,ix]
    tau_ei_in = dict_out['tau_ei'][iy,ix]
    root_in = get_growth(k,Z_in,lambda_T_in,tau_ei_in,n_e_in,T_e_in,Bz_in,wt_in,dxn_in,dxT_in,dxBz_in)
