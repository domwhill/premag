...
p1wt = TEL.plot_custom_xlineout_amp_tevol(fig,ax_d,path_list,var_amp='Te',time_list=time_list,
                                    style_list=style_list,mstyle_list=mstyle_list,
                                    cmap=[shade_of_grey(0.5), shade_of_grey(0.0)],
                                    leg_dict=dict_list,axleg=cax_d)
...
p2 = TEL.plot_ylineout_custom(fig,ax_a,path_list,var_amp='Te',
                                time=time_list[-1],style_list=style_list,
                                mstyle_list=mstyle_list,
                                dict_list=dict_list,cfg=cd5)
