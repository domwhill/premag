...
def custom_contour(ax,xgrid,data,lab, lim, **kwargs):
    ...
    im = ax.contour(
                treat_data(data),levels = lvls,colors=(colors),
...
class PlotContour():
    ...
    def plot(self, fig, ax):
        ...
        lvls = custom_contour(ax, x_grid_b, self.data_k, self.lab, lim=lim, colors='xkcd:red', levels=lvls)
...
def main():
    ...
    cont1.im.set_clim(clim1[0],clim1[-1]*1.1) # make plot slightly more grey by extending limits
