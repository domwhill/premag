...
if __name__ == "__main__":
    ...
    var_list = [
        'n', 'Te', 'Cx', 'Cy', 'Bz', 'ExX', 'ExY', 'EyX', 'EyY', 'qxX', 'qxY', 'qyX', 'qyY', 'jxX',
        'jxY', 'jyX', 'jyY'
    ]
    ...
    for tt in range(len(t_list)):
        ...
        for i, v in enumerate(xrange(number_of_subplots)):
            ...
            im = ax1.imshow(np.log(np.abs(data_dev)), cmap=colormap, aspect=asp, extent=lims)
            ...
            plt.colorbar(im, shrink=0.9, label=var)
            #ax1.colorbar()
