...
if __name__ == "__main__":
    ...
    if True:
        ...
        for tt in t_list:
            ...
            print('1582) =shape = classic bier=  ', np.shape(classic_biermann), 'kinetic bier = ',
                  np.shape(kinetic_biermann), 'shape NERNST = ', np.shape(data_x2d_vN_k),
                  np.shape(data_y2d_tot_k), np.shape(data_x2d_tot_k))
            ...
            print('shape kin bier, classic bier = ', np.shape(data_bier_k), np.shape(data_bier_c),
                  np.shape(classic_biermann[xi_min:x_lim].flatten()))
            ...
            if log_on:
                ...
                print(' SHAPE xgrid = ', np.shape(x_grid_SI[xi_min:x_lim]),
                      np.shape(np.abs(data_bier_k)[:]), 'BIER_FACTR = ', BIER_FACTR)
                ...
                p1bc, = ax3.plot(x_grid_SI[xi_min:x_lim],
