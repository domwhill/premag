...
def plot_2D_irregulargrid(ax,xgrid,ygrid,data,label,middle=None,colormap='jet',limits=None,xlabel=None,ylabel=None,clabel=None,fmt='%0.1e'):
    #fmt = ticker.FuncFormatter(fmt)
    ##fmt = ScalarFormatter(useMathText=True)
    fmt = '%i'
    sample = np.average(np.abs(data))
    ...
    if True:
        ...
        for tt in [13]:
            ...
            for key in it_list:
                ...
                plot_2D_irregulargrid(ax,x_grid_SI[1:-1],y_grid_SI[1:-1],data,
                                    label,middle=mid,colormap='RdBu_r',limits=lims,xlabel=ylab,ylabel=xlab,clabel=' ')
            ...
            savename = save_path + 'im_E_'+str(time) + '.pdf'
